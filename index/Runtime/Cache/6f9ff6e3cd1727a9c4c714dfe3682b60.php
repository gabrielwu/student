...
<frameset rows="200,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="210,*" frameborder="no" border="0" framespacing="0">
    <frame src="<?php echo ($current); ?>/left.html" name="leftFrame" scrolling= "yes" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frame src="<?php echo ($url); ?>/right" name="main" id="main" title="main" />
  </frameset>
</frameset>
<noframes><body>
</body></noframes>
