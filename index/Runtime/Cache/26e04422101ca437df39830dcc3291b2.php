...
<DIV id=wrap>
  <DIV id=content >
    <form action="<?php echo ($url); ?>/updateCompetition" method="post" id="form" target="main">
      <table class="form" width="400" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          ...
          <tr class="">
            <th>大赛名称<span class="star">*</span></th>
            <td>
			    <input name="competition_name" id="competition_name" value="<?php echo ($result["competition_name"]); ?>" type="text">
                <div id=""></div>
			</td>
          </tr>
		  <tr class="">
		  ...
		  <tr class="">
            <th>获奖情况<span class="star"></span></th>
            <td>
        ...
        <tfoot>
          <tr class="">
            <td></td>
            <td><button type="button" onclick="updateCompetition()"  class="add">提交</button>
            </td>
          </tr>
        </tfoot>
      </table>
