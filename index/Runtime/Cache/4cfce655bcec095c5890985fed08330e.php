...
<DIV id=wrap>
  <DIV id=title class=tab>
    <H2>学生事务</H2>
    <UL id=tab>
      <LI ><A href="<?php echo ($url); ?>/index" target="main" >处分首页</A></LI>
  ...
  <DIV id=content >
    <form action="<?php echo ($url); ?>/uploadFile" method="post" id="form" enctype="multipart/form-data">
      <table class="form" width="100%" cellpadding="0" cellspacing="0">
        <thead>
          <tr class="">
            <th colspan="2">处分信息导入&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" color="red">导入文件格式仅为*.xls格式</font></th>
          </tr>
        </thead>
        <tbody>
          <tr class="">
            <th>当如文件附件：</th>
            <td><a href="<?php echo ($url); ?>/download">处分填写表格.xls(<font size="2" color="red">点击可下载</font>)</a>
              <div id=""></div></td>
          </tr>
          <tr class="">
