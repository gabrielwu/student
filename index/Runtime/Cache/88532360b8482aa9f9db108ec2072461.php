...
<DIV id=wrap>
  ...
  <DIV id=content >
    <form action="<?php echo ($url); ?>/update" method="post" id="form" enctype="multipart/form-data" target="main">
	    <input type="hidden" name="id" id="id" value="<?php echo ($result["id"]); ?>"/>
	    <div class="common"><span>标题</span></br><input name="title" id="title" value="<?php echo ($result["title"]); ?>"/></div>
		<div class="common">
		    <span>内容</span></br>
		    <textarea name="content" style="width:800px;height:400px;visibility:hidden;"><?php echo ($result["content"]); ?></textarea>
			<p>
			    <input type="submit" name="submit" value="提交编辑" />
