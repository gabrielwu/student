...
<DIV id=wrap>
  <DIV id=content >
    <form action="<?php echo ($url); ?>/updateSocialScholar" method="post" id="form" target="main">
      <table class="form" width="400" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          ...
          <tr class="">
            <th>社会奖学金名称<span class="star">*</span></th>
            <td>
        ...
        <tfoot>
          <tr class="">
            <td></td>
            <td><button type="button" onclick="updateSocialScholar()"  class="add">提交</button>
            </td>
          </tr>
        </tfoot>
      </table>
