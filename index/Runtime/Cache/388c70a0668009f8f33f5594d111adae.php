...
<DIV id=wrap>
  <DIV id=title class=tab>
    <H2>学生事务</H2>
    <UL id=tab>
      <LI ><A href="<?php echo ($url); ?>/index" target="main" >国家助学金首页</A></LI>
  ...
  <DIV id=content >
    <form action="<?php echo ($url); ?>/downdatafile" method="post" id="form" enctype="multipart/form-data">
      <table class="form" width="100%" cellpadding="0" cellspacing="0">
        <thead>
          <tr class="">
            <th colspan="2">国家助学金信息导出&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2" color="red">导出文件格式仅为*.xls格式
            按"获助时年级"(如果是08年入学 即为 "2008")
     按"获助年份" (如果是08年获得助学金 即为"2008")
             如果条件为空 则导出历年来的数据！！！
        ...
        <thead>
          <tr class="">
            <th colspan="2" align="left">导出文件内容 <span class="star">*</span>
           	 查询条件：
            	按"获助时年级"<input type="text" name="stu_grade">
            	按"获助年份"<input type="text" name="sch_year">
